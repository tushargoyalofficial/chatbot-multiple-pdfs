...
# above one is too heavy and require very high configuration machine.
        ...
        if st.button("Process"):
            if pdf_docs is not None:
                with st.spinner("Processing..."):
                    ...
                    # create conversation chain (st.session_state to persist the variable
                    # as stramlit reloads all on button press)
